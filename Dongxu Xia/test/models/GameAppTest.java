...
public class GameAppTest {
    ...
    void setUp() {
        ...
        edAppBelowBoundary = new ProductivityApp(developerLego, "WeDo", 1, 1.0, 0, 1);
        edAppOnBoundary = new ProductivityApp(developerLego, "Spike", 1000, 2.0, 1.99, 10);
        edAppAboveBoundary = new ProductivityApp(developerLego, "EV3", 1001, 3.5, 2.99, 11);
        edAppInvalidData = new ProductivityApp(developerLego, "", -1, 0, -1.00,0);
    }
    ...
    class ObjectStateMethods {
        ...
        void appSummaryReturnsCorrectString() {
            ProductivityApp edApp = setupGameAppWithRating(3, 4);
    ...
    class RecommendedApp {
        ...
        void appIsNotRecommendedWhenRatingIsLessThan3AndAHalf() {
            ...
            ProductivityApp edApp = setupGameAppWithRating(3, 3);

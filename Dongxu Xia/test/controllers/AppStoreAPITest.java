...
public class AppStoreAPITest {
    ...
    void setUp() {
        ...
        prodAppBelowBoundary = new ProductivityApp(developerApple, "NoteKeeper", 1, 1.0, 0.0, 10);

        prodAppOnBoundary = new ProductivityApp(developerMicrosoft, "Outlook", 1000, 2.0, 1.99, 10);

        prodAppAboveBoundary = new ProductivityApp(developerApple, "Pages", 1001, 3.5, 2.99, 10);

        prodAppInvalidData = new ProductivityApp(developerMicrosoft, "", -1, 0, -1.00, 10);

...
public class DeveloperAPI {
    ...
    public String searchByDeveloperName(String appName) {
        String matchingApp = "";
        for(Developer developer : developers) {
            if (developer.getDeveloperName().toUpperCase().contains(appName.toUpperCase())) {
                matchingApp += developers.indexOf(developer) + ": " + developer + "\n";
            }
        }
